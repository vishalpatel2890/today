...
2. **Ask clarifying questions **to capture sufficient information to track idea for future. 
3. **Determine location** based on context (plan, related feature, or global tracker)
4. **Generate ULID** for the unique idea ID
5. **Create idea entry** with proper inline syntax
6. **Add to appropriate section** in the target file
7. **Confirm** to the user where the idea was tracked
